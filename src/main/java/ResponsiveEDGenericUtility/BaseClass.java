...
import ResponsiveEDObjectReposotary.loginPage;
...
public class BaseClass {
	...
	public propertiesGeniricUtility p = new propertiesGeniricUtility();
	...
	public void lanchbrowser() throws Exception
	{
		...
		String BROWSER = p.getDataFromFile("browser");
